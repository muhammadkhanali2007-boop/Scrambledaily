  ...
  return (
    <main className="px-6 py-[60px]">
      <article className="mx-auto w-full max-w-[680px]">
        <h1 className="mb-3 font-display text-[2rem] font-extrabold leading-tight text-luxe-strong">
          About Word Unscramble Game
        </h1>

        <p className="mb-6 text-[17px] italic leading-[1.8] text-luxe-secondary">
          <strong className="font-semibold text-luxe-strong">
            We built this because words deserve better.
          </strong>
        </p>

        <p className="mb-6 text-[17px] leading-[1.8] text-luxe-secondary">
        ...
        <h2 className="mt-10 border-b border-luxe pb-2 font-display text-[1.3rem] font-semibold text-luxe-strong">
          What We Built and Why
        </h2>

        <p className="mt-6 mb-3 text-[17px] leading-[1.8] text-luxe-secondary">
          <strong className="font-semibold text-luxe-strong">
        ...
        <p className="mb-3 text-[17px] leading-[1.8] text-luxe-secondary">
          <strong className="font-semibold text-luxe-strong">
        ...
        <p className="mt-6 mb-6 text-[17px] leading-[1.8] text-luxe-secondary">
        ...
        <p className="mt-6 mb-4 text-[17px] leading-[1.8] text-luxe-secondary">
          Have a question, a suggestion, or want to report something? Our team reads every message
          and responds.
        </p>

        <p className="mb-6 text-[17px] leading-[1.8] text-luxe-secondary">
          <strong className="font-semibold text-luxe-strong">Email: </strong>
          <a
            href="mailto:muhammadkhanali2007@gmail.com"
            className="font-bold text-luxe-accent-mid no-underline hover:underline"
          >
            muhammadkhanali2007@gmail.com
          </a>
        </p>

        <p className="text-[17px] italic leading-[1.8] text-luxe-tertiary">We are happy to hear from you.</p>
      </article>
    </main>
  );
}
